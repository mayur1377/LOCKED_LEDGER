...
## WHAT IT IS
• A decentralised file storing application for storing small files in a secure way by uploading it into the IPFS chain
 
![alt text](https://i.ibb.co/M8mTNqY/image.png)
...
[ ] Hosting  : errors in hosting in verecel
 ...
 until then see how to create react app or something
